  ...
  const getSourceInfo = () => {
    ...
    if (isAI && source === 'gemini_ai') {
      return {
        type: 'ai',
        icon: '🤖',
        label: language === 'Hindi' ? 'AI-generated' : 'AI-generated',
        description: language === 'Hindi' 
          ? 'यह उत्तर AI द्वारा आपके प्रश्न के लिए विशेष रूप से तैयार किया गया है'
          : 'This response was specifically generated by AI for your question',
    ...
    if (source === 'template_fallback' || source === 'hardcoded_fallback') {
      return {
        type: 'template',
        icon: '📜',
        label: language === 'Hindi' ? 'Traditional Wisdom' : 'Traditional Wisdom',
        description: language === 'Hindi'
          ? 'यह पारंपरिक ज्ञान का एक संकलित उत्तर है, जो शास्त्रों से लिया गया है'
          : 'This is curated traditional wisdom from authentic scriptures',
    ...
    if (source === 'hybrid_rag' || source === 'simple_rag') {
      return {
        type: 'enhanced',
        icon: '📚',
        label: language === 'Hindi' ? 'Enhanced Search' : 'Enhanced Search',
        description: language === 'Hindi'
          ? 'यह उत्तर वेक्टर सर्च और AI के संयोजन से तैयार किया गया है'
          : 'This response combines vector search with AI generation',
    ...
    return {
      type: 'unknown',
      icon: '⚡',
      label: language === 'Hindi' ? 'Spiritual Guidance' : 'Spiritual Guidance',
      description: language === 'Hindi'
...
const ResponseDisplay: React.FC<ResponseDisplayProps> = ({
  ...
  return (
    <div className="response-display bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-neutral-200/50 p-6 mb-6 transition-all hover:shadow-xl">
      ...
      {/* Response Source Transparency - Gap Remediation Feature */}
      {response.metadata && (
        <div className="response-source-indicator mb-4">
          <ResponseSourceBadge 
