...
// RESOURCE ORGANIZATION: Split into two resource groups:
...
@description('Production environment - single environment deployment for cost efficiency')
...
// These names are minimal and consistent across deployments
